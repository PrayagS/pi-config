...
- **Firecrawl** — falls back to Firecrawl scrape API (`https://api.firecrawl.dev/v2/scrape`) before markdown.new; requires `PI_WEB_FETCH_FIRECRAWL_API_KEY` environment variable
