...
export function createWebSearchTool(pi: ExtensionAPI) {
  ...
  renderCall(args: any, theme: any): typeof Text.prototype {
    ...
    if (args.order && args.order !== "default")
      tags.push(`order:${args.order}`)
  ...
  renderResult(result: any, { expanded }: { expanded: boolean }, theme: any): typeof Text.prototype {
